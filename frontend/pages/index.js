...
export default function Home() {
  ...
  const startInterview = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://cbbd10e84072.ngrok-free.app/api/start-interview', {
        method: 'POST',
        headers: {
  ...
  const submitAnswer = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://cbbd10e84072.ngrok-free.app/api/submit-answer', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const endInterview = async () => {
    ...
    try {
      const response = await fetch('https://cbbd10e84072.ngrok-free.app/api/end-interview', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
